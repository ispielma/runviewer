...
class RunViewer(object):
    def __init__(self, exp_config):
        ...
        self.ui.actionLoad_runviewer_state.triggered.connect(self.on_load_runviewer_state)
        self.ui.actionSave_runviewer_state.triggered.connect(self.on_save_runviewer_state)
    ...
    def get_save_data(self):
        """Return the runviewer GUI state stored in app config."""
    ...
    def load_configuration(self, filename):
        """Load runviewer GUI state from a TOML config file."""
        save_data = load_appconfig(filename).get('runviewer_state', {})
        ...
        self.last_save_config_file = os.path.abspath(filename)
